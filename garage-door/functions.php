...
if ( ! function_exists( 'pet_business_setup' ) ) :
	...
	function pet_business_setup() {
		...
		set_post_thumbnail_size( 727, 566, true );
...
function pet_business_content_width() {
	...
	/**
	 * Filter Garage Door content width of the theme.
	 *
	 * @since Garage Door 1.0.0
	 *
...
function pet_business_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Top Social Links', 'pet-business' ),
		'id'            => 'top_social_links',
		'description'   => esc_html__( 'Add widgets here.', 'pet-business' ),
		'before_widget' => '<aside>',
		'after_widget'  => '</aside>',
...
function pet_business_scripts() {
	...
	wp_enqueue_style( 'pet-business-fonts', pet_business_fonts_url(), array(), null );
	...
	wp_enqueue_style( 'magnific-popup', get_template_directory_uri() . '/assets/css/magnific-popup' . pet_business_min() . '.css' );
	...
	wp_enqueue_script( 'jquery-match-height', get_template_directory_uri() . '/assets/js/jquery-matchHeight' . pet_business_min() . '.js', array( 'jquery' ), '', true );

	wp_enqueue_script( 'jquery-sidr', get_template_directory_uri() . '/assets/js/jquery.sidr' . pet_business_min() . '.js', array( 'jquery' ), '', true );

	wp_enqueue_script( 'isotope', get_template_directory_uri() . '/assets/js/isotope.pkgd' . pet_business_min() . '.js', array( 'jquery' ), '', true );

	wp_enqueue_script( 'jquery-imagesloaded', get_template_directory_uri() . '/assets/js/imagesloaded.pkgd' . pet_business_min() . '.js', array( 'jquery' ), '', true );

	wp_enqueue_script( 'jquery-magnific', get_template_directory_uri() . '/assets/js/jquery.magnific-popup' . pet_business_min() . '.js', array( 'jquery' ), '', true );

	// custom script
	wp_register_script( 'pet-business-custom', get_template_directory_uri() . '/assets/js/custom' . '.js', array( 'jquery' ), '', true );

	$current_site = site_url();
	$data = array( 'current_site' => $current_site );

	wp_localize_script( 'pet-business-custom', 'data', $data );

	wp_enqueue_script( 'pet-business-custom' );
}
