...
if ( ! function_exists( 'pet_business_sortable_sections' ) ) :
    ...
    function pet_business_sortable_sections() {
        $sections = array(
            ...
            'service'    => esc_html__( 'Request a quote', 'pet-business' ),
            'welcome'     => esc_html__( 'Welcome', 'pet-business' ),
            'project' => esc_html__( 'Our Services', 'pet-business' ),
//            'coupons' => esc_html__( 'Coupons For You', 'pet-business' ),
            'team'       => esc_html__( 'Team', 'pet-business' ),
            'blog'      => esc_html__( 'Blog', 'pet-business' ),
            'testimonial' => esc_html__( 'Testimonial', 'pet-business' ),            
            'cta'       => esc_html__( 'Contact Us', 'pet-business' ),
