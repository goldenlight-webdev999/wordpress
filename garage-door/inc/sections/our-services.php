   ...
   function pet_business_render_project_section( $content_details = array() ) {
        ...
        <div id="latest-projects" class="relative page-section">
            <div class="wrapper">
                ...
                <div class="section-header">
                    <?php if ( ! empty( $options['project_description'] ) ) : ?>
                        <h4 class="section-description"><?php echo esc_html( $options['project_description'] ); ?></h4>
                    <?php endif; ?>
                </div><!-- .section-description -->

                <?php 
                    $i = 1;
                    $total = count($content_details);
                    foreach ( $content_details as $content ) : ?>
                        <style>
                            .top-slider .slick-slide:nth-of-type(<?php echo $i ?>) article {
                        ...
                        <?php if ($i < ($total/2)+1) : ?>
                            ...
                            <style>
                                .bottom-slider .slick-slide:nth-of-type(<?php echo round(($i+($total/2))) ?>) article {
                                    background-image: url('<?php echo esc_url( $content['image'] ); ?>');
                                }                       
                            </style>
                ...
                <div class="project-slider top-slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "infinite": true, "speed": 1000, "dots": false, "arrows":false, "autoplay": false, "fade": false }'>
                    <?php 
                    $i = 1;
                    foreach ( $content_details as $content ) :
                        if ($i < 4) : 
                            ...
                            <div class="caption">
                                <?php if ( ! empty( $content['title'] ) ) : ?>
                                    <div class="entry-caption">
                                        <h4 class="entry-title"><?php echo esc_html( $content['title'] ); ?></h4>
                                    </div>
                                <?php endif; ?>
                            </div>
                                ...
                                <div class="entry-container">
                                    <?php if ( ! empty( $content['content'] ) ) : ?>
                                        <header class="entry-header">
                                            <h2 class="entry-title"><a href="<?php echo esc_url( $content['url'] ); ?>"><?php echo esc_html( $content['content'] ); ?></a></h2>
                                        </header>
                                    <?php endif; ?>
                                </div><!-- .entry-container -->
                            </div><!-- .entry-container -->                        
                ...
                <div class="project-slider bottom-slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "infinite": true, "speed": 1000, "dots": false, "arrows":false, "autoplay": false, "fade": false }'>
                    <?php 
                    $i = 1;
                    foreach ( $content_details as $content ) :
                        if ($i > 3) : 
