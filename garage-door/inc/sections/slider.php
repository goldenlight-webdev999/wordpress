                ...
                <article style="background-image: url('<?php echo esc_url( $content['img'] ); ?>');">
                    ...
                    <div class="entry-container">
                        ...
                        <div class="buttons">
                            ...
                            <?php if ( ! empty( $options['slider_content_custom_btn_2_' . $i ] ) ) : 
                                $btn_1_url = ! empty( $options['slider_content_custom_url_2_' . $i ] ) ? $options['slider_content_custom_url_2_' . $i ] : '';
                                ?>
                                <a href="<?php echo esc_url( $btn_2_url ); ?>" class="btn btn-default"><?php echo esc_html( $options['slider_content_custom_btn_2_' . $i ] ); ?></a>
                            <?php endif; ?>
                        </div><!-- .buttons -->
                    </div>
                </article>
