...
if ( ! class_exists( 'Pet_Business_Latest_Post' ) ) :

     
    class Pet_Business_Latest_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive latest posts.', 'pet-business' ),
            );
            parent::__construct( 'pet_business_latest_post', esc_html__( 'TP : Latest Posts', 'pet-business' ), $tp_widget_popular_post );
        }
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Latest Posts', 'pet-business' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
           ?>
           ...
           <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show:', 'pet-business' ); ?></label>
