...
function pet_business_customize_register( $wp_customize ) {
	...
	// Site Call now options.
	$wp_customize->add_setting( 'pet_business_theme_options[header_call_title]', array(
		'default'           => $options['header_call_title'],
		'sanitize_callback' => 'pet_business_sanitize_select',
		'transport'			=> 'refresh'
	) );

	$wp_customize->add_control( 'pet_business_theme_options[header_call_title]', array(
		'priority'			=> 50,
		'type'				=> 'text',
		'label'             => esc_html__( 'Site Call Title', 'pet-business' ),
		'section'           => 'title_tagline'		
	) );
	$wp_customize->add_setting( 'pet_business_theme_options[header_call_caption]', array(
		'default'           => $options['header_call_caption'],
		'sanitize_callback' => 'pet_business_sanitize_select',
		'transport'			=> 'refresh'
	) );

	$wp_customize->add_control( 'pet_business_theme_options[header_call_caption]', array(
		'priority'			=> 50,
		'type'				=> 'text',
		'label'             => esc_html__( 'Site Call Caption', 'pet-business' ),
		'section'           => 'title_tagline'		
	) );
	$wp_customize->add_setting( 'pet_business_theme_options[header_call_number]', array(
		'default'           => $options['header_call_number'],
		'sanitize_callback' => 'pet_business_sanitize_select',
		'transport'			=> 'refresh'
	) );

	$wp_customize->add_control( 'pet_business_theme_options[header_call_number]', array(
		'priority'			=> 50,
		'type'				=> 'text',
		'label'             => esc_html__( 'Site Call Number', 'pet-business' ),
		'section'           => 'title_tagline'		
	) );
	...
	$wp_customize->add_panel( 'pet_business_theme_options_panel' , array(
	    ...
	    'description'=> esc_html__( 'Garage Door Theme Options.', 'pet-business' ),
	    'priority'   => 150,
	) );
	...
	// load service option
	require get_template_directory() . '/inc/customizer/sections/request-quote.php';
	
	// load about option
	require get_template_directory() . '/inc/customizer/sections/welcome.php';

	// load subscribe option
	require get_template_directory() . '/inc/customizer/sections/our-services.php';	

	// load team option
	require get_template_directory() . '/inc/customizer/sections/coupons.php';	
