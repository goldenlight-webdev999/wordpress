...
$wp_customize->add_setting( 'pet_business_theme_options[designed_text]',
	array(
		'default'       		=> $options['designed_text'],
		'sanitize_callback'		=> 'pet_business_santize_allow_tag',
		'transport'				=> 'postMessage',
	)
);
$wp_customize->add_control( 'pet_business_theme_options[designed_text]',
    array(
		'label'      			=> esc_html__( 'Desgined Text', 'pet-business' ),
		'section'    			=> 'pet_business_section_footer',
		'type'		 			=> 'textarea',
    )
);
