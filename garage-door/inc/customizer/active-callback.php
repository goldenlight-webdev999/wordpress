 ...
 * @return bool Whether the control is active to the current preview.
 */
function pet_business_is_welcome_section_enable( $control ) {
	return ( $control->manager->get_setting( 'pet_business_theme_options[welcome_section_enable]' )->value() );
}

/**
 * Check if coupons section is enabled.
 *
 * @since Garage Door 1.0.0
 * @param WP_Customize_Control $control WP_Customize_Control instance.
 * @return bool Whether the control is active to the current preview.
 */
/*function pet_business_is_coupons_section_enable( $control ) {
	return ( $control->manager->get_setting( 'pet_business_theme_options[coupons_section_enable]' )->value() );
}*/
