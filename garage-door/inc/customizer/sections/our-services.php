...
$wp_customize->add_section( 'pet_business_project_section', array(
	'title'             => esc_html__( 'Our Services','pet-business' ),
	'description'       => esc_html__( 'Our Services Section options.', 'pet-business' ),
...
$wp_customize->add_control( new Pet_Business_Switch_Control( $wp_customize, 'pet_business_theme_options[project_section_enable]', array(
	'label'             => esc_html__( 'Our Services Section Enable', 'pet-business' ),
...
// project description setting and control
$wp_customize->add_setting( 'pet_business_theme_options[project_description]', array(
	'sanitize_callback' => 'sanitize_text_field',
	'default'			=> $options['project_description'],
	'transport'			=> 'postMessage',
) );

$wp_customize->add_control( 'pet_business_theme_options[project_description]', array(
	'label'           	=> esc_html__( 'Description', 'pet-business' ),
	'section'        	=> 'pet_business_project_section',
	'active_callback' 	=> 'pet_business_is_project_section_enable',
	'type'				=> 'textarea',
) );
...
if ( isset( $wp_customize->selective_refresh ) ) {
    ...
    /*$wp_customize->selective_refresh->add_partial( 'pet_business_theme_options[project_description]', array(
		'selector'            => '#latest-projects h2.section-title',
		'settings'            => 'pet_business_theme_options[project_description]',
		'container_inclusive' => false,
		'fallback_refresh'    => true,
		'render_callback'     => 'pet_business_project_title_partial',
    ) );*/
