...
for ( $i = 1; $i <= 3; $i++ ) :
	...
	// slider custom button 2
	$wp_customize->add_setting( 'pet_business_theme_options[slider_content_custom_btn_2_' . $i . ']', array(
		'sanitize_callback' => 'sanitize_text_field',
	) );

	$wp_customize->add_control( 'pet_business_theme_options[slider_content_custom_btn_2_' . $i . ']', array(
		'label'             => esc_html__( 'Button Two', 'pet-business' ),
		'section'           => 'pet_business_slider_section',
		'type'				=> 'url',
		'active_callback'	=> 'pet_business_is_slider_section_enable',
	) );
	...
	// slider custom url 2
	$wp_customize->add_setting( 'pet_business_theme_options[slider_content_custom_url_2_' . $i . ']', array(
		'sanitize_callback' => 'esc_url_raw',
	) );

	$wp_customize->add_control( 'pet_business_theme_options[slider_content_custom_url_2_' . $i . ']', array(
		'label'             => esc_html__( 'URL Two', 'pet-business' ),
		'section'           => 'pet_business_slider_section',
		'type'				=> 'url',
		'active_callback'	=> 'pet_business_is_slider_section_enable',
	) );
