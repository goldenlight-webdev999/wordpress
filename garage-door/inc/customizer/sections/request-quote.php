...
$wp_customize->add_section( 'pet_business_service_section', array(
	'title'             => esc_html__( 'Request a Quote','pet-business' ),
	'description'       => esc_html__( 'Request a Quote Section options.', 'pet-business' ),
...
$wp_customize->add_control( new Pet_Business_Switch_Control( $wp_customize, 'pet_business_theme_options[service_section_enable]', array(
	'label'             => esc_html__( 'Request a Quote Section Enable', 'pet-business' ),
...
$wp_customize->add_setting( 'pet_business_theme_options[service_sub_title]', array(
	'sanitize_callback' => 'sanitize_text_field',
	'default'			=> $options['service_sub_title'],
	'transport'			=> 'postMessage',
) );

$wp_customize->add_control( 'pet_business_theme_options[service_sub_title]', array(
	'label'           	=> esc_html__( 'Sub Title', 'pet-business' ),
	'section'        	=> 'pet_business_service_section',
	'active_callback' 	=> 'pet_business_is_service_section_enable',
	'type'				=> 'text',
) );
...
for ( $i = 1; $i <= 1; $i++ ) :
	...
	$wp_customize->add_control( new Pet_Business_Dropdown_Chooser( $wp_customize, 'pet_business_theme_options[service_content_page_' . $i . ']', array(
		'label'             => sprintf( esc_html__( 'Select Page ', 'pet-business' ), $i ),
		'section'           => 'pet_business_service_section',
