...
function pet_business_get_default_theme_options() {
	...
	$pet_business_default_options = array(
		...
		// Call info
		'header_call_title'				=> 'Call now',
		'header_call_caption'			=> '1-800-123-1234',
		'header_call_number'			=> '18001231234',
		...
		'team_title'					=> esc_html__( 'Coupons For You', 'pet-business' ),

		// Welcome
		'welcome_section_enable'			=> false,
		'read_more_btn_title'				=> esc_html__( 'Read more', 'pet-business' ),
		'contact_us_btn_title'				=> esc_html__( 'Contact Us', 'pet-business' ),

		// service
		'service_section_enable'		=> false,
		'service_title'					=> esc_html__( 'Request a Quote Section Enable', 'pet-business' ),

		// project
		'project_section_enable'		=> false,
		'project_title'					=> esc_html__( 'Our Services', 'pet-business' ),	

		// testimonial
		'testimonial_section_enable'	=> false,
		'testimonial_title'				=> esc_html__( 'Our Garage Door Lovers', 'pet-business' ),
