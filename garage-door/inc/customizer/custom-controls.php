 ...
 */
class Pet_Business_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Pet_Business_Dropdown_Category_Control extends WP_Customize_Control {
...
class Pet_Business_Note_Control extends WP_Customize_Control {
...
class Pet_Business_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Pet_Business_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="pet-business-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Pet_Business_Custom_Radio_Image_Control extends WP_Customize_Control {
...
Class Pet_Business_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
...
class Pet_Business_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="pet-business-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'pet-business' ); ?>" class="pet-business-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
 ...
 * @since  1.0.0
 */
class Pet_Business_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
